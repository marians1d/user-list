    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button onClick={() => onAction(user._id, userActions.update)} className="btn edit-btn" title="Edit">
                ...
                <button onClick={() => onAction(user._id, userActions.delete)} className="btn delete-btn" title="Delete">
                ...
                <button onClick={() => onAction(user._id, userActions.details)} className="btn info-btn" title="Info">
